...
public class JDlgJogo extends javax.swing.JDialog {
    ...
    public JDlgJogo(java.awt.Frame parent, boolean modal) {
        ...
        Util.habilitar(false, jFmtAno, jTxtAvaliacao, jTxtBrinde, jTxtClassificacao,
                jTxtDesconto, jTxtEdicao, jTxtEmpresa, jTxtEstoque, jTxtID, jTxtIdioma, 
                jTxtNome, jTxtPreco, jBtnCancelar, jBtnConfirmar);
    ...
    public MslfJogo viewBean() {
        ...
        // jogo.setMslfAno(Util.strDate(jFmtAno));
        ...
        // jogo.setMslfIdJogo(Util.intStr(jTxtID));
     ...
     public void beanView(MslfJogo jogo) {
        // jTxtID.setText( Util.intStr(jogo.getMslfIdJogo()) ); // AQUI
    ...
    private void jBtnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCancelarActionPerformed
       ...
       Util.habilitar(false, jFmtAno, jTxtAvaliacao, jTxtBrinde, jTxtClassificacao,
                jTxtDesconto, jTxtEdicao, jTxtEmpresa, jTxtEstoque, jTxtID, jTxtIdioma, 
                jTxtNome, jTxtPreco, jBtnCancelar, jBtnConfirmar);
        Util.limparCampos(jFmtAno, jTxtAvaliacao, jTxtBrinde, jTxtClassificacao,
                jTxtDesconto, jTxtEdicao, jTxtEmpresa, jTxtEstoque, jTxtID, jTxtIdioma, 
                jTxtNome, jTxtPreco);
...
//        beanView(cliente);
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        // TODO add your handling code here:
       Util.habilitar(true, jFmtAno, jTxtAvaliacao, jTxtBrinde, jTxtClassificacao,
                jTxtDesconto, jTxtEdicao, jTxtEmpresa, jTxtEstoque, jTxtID, jTxtIdioma, 
                jTxtNome, jTxtPreco, jBtnExlcuir, jBtnPesquisar, jBtnIncluir, jBtnAlterar);
         Util.limparCampos(jFmtAno, jTxtAvaliacao, jTxtBrinde, jTxtClassificacao,
                jTxtDesconto, jTxtEdicao, jTxtEmpresa, jTxtEstoque, jTxtID, jTxtIdioma, 
                jTxtNome, jTxtPreco);
        incluindo = true;
